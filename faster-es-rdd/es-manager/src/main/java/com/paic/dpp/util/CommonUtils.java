...
public class CommonUtils {
    ...
    public static void tarFile(String srdDir, String dstTar) throws Exception {
        ...
        String tarCmd = "tar -zcvf " + dstTar + " " + srdDir;
        execCmd(tarCmd);
